...
export default function Tournaments() {
  return (
    <Layout>
      <div className="w-full h-[204px] bg-tournamentsImage bg-cover bg-no-repeat bg-center lg:bg-[center_top_-11rem] flex flex-col justify-center gap-1 items-start p-5 lg:pl-[170px]">
