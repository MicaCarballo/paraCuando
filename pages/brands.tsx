...
export default function Brands() {
  return (
    <Layout>
      <div className="w-full h-[204px] bg-brandsImageMobile sm:bg-brandsImage bg-cover bg-no-repeat bg-bottom flex flex-col justify-center gap-1 items-start p-5 lg:pl-[170px]">
